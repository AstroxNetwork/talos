export const idlFactory = ({ IDL }) => {
  ...
  const Result = IDL.Variant({ 'Ok' : StakingWallet, 'Err' : IDL.Text });
  ...
  return IDL.Service({
    'create_staking_wallet' : IDL.Func([StakingWalletCreateReq], [Result], []),
    ...
    'update_staking_wallet' : IDL.Func([StakingWallet], [Result_2], []),
