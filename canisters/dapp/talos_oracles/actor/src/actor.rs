...
// ------------------
// injected macros
use talos_oracles_mod::state::*;
use talos_oracles_mod::types::{Example, UserProfile, UserWallet};
...
#[pre_upgrade]
pub fn pre_upgrade() {
    talos_oracles_mod::state::pre_upgrade()
}

#[post_upgrade]
pub fn post_upgrade() {
    talos_oracles_mod::state::post_upgrade();
}
...
pub fn get_all_users() -> Vec<UserProfile> {
    info_log_add("talos: get_all_users");
...
pub fn get_all_wallets() -> Vec<UserWallet> {
    info_log_add("talos: get_all_wallets");
